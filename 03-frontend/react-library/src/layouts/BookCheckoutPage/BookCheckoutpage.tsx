...
export const BookCheckoutPage = () => {
     ...
     //Counter for Loans yani the number of times a user has checked out books
     //we have set it to total 5 and out of them the counter will show how many
     //Loan State
...
// //this useEffect is used to call for reviews for a specifc book
     useEffect(() => {
...
useEffect(() => {
     const fetchUserCheckedOutBook =async () => {
          if(authState && authState.isAuthenticated){
               ...
               const BookCheckOutResponseJson = await bookCheckedOut.json();

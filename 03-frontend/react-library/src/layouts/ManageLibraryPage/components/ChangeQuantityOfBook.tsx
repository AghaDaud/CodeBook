            ...
            <div className='row g-0'>
                ...
                <div className='mt-3 col-md-4'>
                    <div className='d-flex justify-content-center algin-items-center'>
                        <p>Payments Required: <b>{quantity}</b></p>
                    </div>
                    <div className='d-flex justify-content-center align-items-center'>
                        <p>Payments Remaining: <b>{remaining}</b></p>
                    </div>
                </div>
                ...
                <button className='m1 btn btn-md main-color text-white' onClick={increaseQuantity}>Add Payments req</button>
                <button className='m1 btn btn-md btn-warning' onClick={decreaseQuantity}>Decrease Payment req</button>
            </div>
        </div>
    );
}
...
export const SearchBookPage = () => {
  ...
  const index0fLastBook: number = currentPage * booksPerPage;
  const indexOfFirstBook: number = index0fLastBook - booksPerPage;
  let lastItem =
          ...
          <div className="row mt-5">
            ...
            <div className="col-4">
              <div className="dropdown">
                <button
                  className="btn btn-secondary dropdowno-toggle"
                  type="button"
